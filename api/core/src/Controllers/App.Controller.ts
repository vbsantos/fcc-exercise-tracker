...
export class AppController implements IAppController {
  ...
  /**
   * A GET route for retrieving a user's exercise log.
   * This route should return a user object with a count property representing the number of exercises that belong to that user and a log array containing all the exercises. The log array should contain objects with description, duration, and date properties.
